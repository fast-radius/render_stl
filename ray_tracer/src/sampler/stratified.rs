...
mod stratified_sampler_tests {
    ...
    fn generates_stratified_samples_incrementally() {
        ...
        let xy_samples = [s0_xy, s1_xy, s2_xy, s3_xy, s4_xy, s5_xy];
        let t_samples = [s0_t, s1_t, s2_t, s3_t, s4_t, s5_t];
        let uv_samples = [s0_uv, s1_uv, s2_uv, s3_uv, s4_uv, s5_uv];
        ...
        let strata_1d = [strata0, strata1, strata2, strata3, strata4, strata5];
        ...
        let strata_2d = [strata00, strata10, strata01, strata11, strata02, strata12];
